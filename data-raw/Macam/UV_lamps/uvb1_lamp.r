...
qpanel.uvb313.data <- read.csv(file="./data-raw/Macam/UV_lamps/Q-Panel_UVB-313.csv", skip=2, header=FALSE, col.names=c("w.length", "s.e.irrad"), nrows=561)
...
qpanel.uva340.data <- read.csv(file="./data-raw/Macam/UV_lamps/Q-Panel_UVA-340.csv", skip=2, header=FALSE, col.names=c("w.length", "s.e.irrad"), nrows=561)
...
philips.tl12.data <- read.csv(file="./data-raw/Macam/UV_lamps/Philips_TL12.csv", skip=2, header=FALSE, col.names=c("w.length", "s.e.irrad"), nrows=561)
...
save(macam.mspct, file="./data-raw/rda/macam-mspct.rda")
