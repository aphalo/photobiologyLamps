...
uv_lamps <- 
        sort(c("germicidal", "philips.tl01", "philips.tl12", 
               "philips.tl12.mc", "philips.BLB.tld108", "LCDlighting.UVA.BL",
               "qpanel.uva340", "qpanel.uvb313", "convoy.2p.uv.flashlight",
               "cree.uv.flashlight", "jaxman.uc1flood.uv.flashlight"))
...
white_lamps <- 
        sort(c("philips.pls11w.827", "philips.tld36w.83", 
               "philips.tld36w.865",
               ...
               "pirkka.halogen.53w", "valoya.b50.ap67", 
               "fluence.PhysioSpecGreenhouse",
...
## test vectors
color_idxs <- 
        unique(c(uv_lamps, amber_lamps, red_lamps, blue_lamps, white_lamps))
...
## Test that all lamps are listed at least in one list of names
