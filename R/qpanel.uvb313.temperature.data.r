...
#' 
#' Absolute values are comparable among the different temperatures. The laamps 
...
#' temperature of 22 C. After each change in the temperarure controller 
...
#' @docType data
#' @keywords datasets
#' @format A data source.spct with 777 rows (290 nm to 400 nm, 1.0 nm step) and 3
#'   variables.
#' @name qpanel.uvb313.temp.spct
#'   
NULL
#' Spectral irradiance data for UVB lamps at different temperatures.
#'
...
#' @docType data
#' @keywords datasets
#' @format A source.spct with 111 rows (290 nm to 400 nm, 1.0 nm step) and 4 variables.
#' @name qpanel.uvb313.temperature.spct
#' @aliases qpanel.uvb313.minus5C.spct qpanel.uvb313.00C.spct qpanel.uvb313.05C.spct qpanel.uvb313.10C.spct qpanel.uvb313.20C.spct qpanel.uvb313.30C.spct qpanel.uvb313.35C.spct
NULL