...
#' @docType data
#' @keywords datasets
#' @format A data table with 301 rows (250 nm to 400 nm, 1.0 nm step) and 4 variables.
#' @name qpanel.uvb313.temperature.dt
#' 
NULL
#' Spectral irradiance data for UVB lamps at different temperatures.
#'
...
#' @docType data
#' @keywords datasets
#' @format A source.spct with 301 rows (250 nm to 400 nm, 1.0 nm step) and 4 variables.
