...
#' 
#' Dataset of spectral irradiance from a set of two Q-Panel UVB-313 and UVA-340
#' 40W fluorescent tubes, and for Philips TL12 40W.
#' 
...
#' The lamps were probably driven by a high frequency electronic ballast.
#' Measured bwteen 1996 to 1998.
#' 
...
#' @docType data
#' @keywords datasets
#' @format A source.spct with 561 rows (240 nm to 800 nm, 1.0 nm step) and 3
#'   variables.
