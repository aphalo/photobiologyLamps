...
Collections `amaran_m9.mspct`, `andoer_ir49.mspct`, `elgato_klm_cct.mspct`, 
`elgato_klm_dim.mspct` and `sunwayfoto_fl96.mspct` contain spectra for video
and photography small LED lamps.
...
The `lamps.mspct` collection, and object of class `source_mspct`, contains 
